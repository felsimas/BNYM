...
- (id)init {
    if (self = [super init]) {
		CFURLRef pdfURL = CFBundleCopyResourceURL(CFBundleGetMainBundle(), CFSTR("bnym.pdf"), NULL, NULL);
...
-(SEL)zoomOut {
	...
	//UIBarButtonItem *zoomInButton = [[UIBarButtonItem alloc] initWithTitle:@"Zoom" style:UIBarButtonItemStylePlain target:self action:@selector(zoomIn)];
    UIBarButtonItem *backButton = [[UIBarButtonItem alloc] initWithTitle:@"goBack" style:UIBarButtonItemStylePlain target:self action:@selector(goBack)];
